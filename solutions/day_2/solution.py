...
def solution1(data):
    ...
    for opponent_choice, player_choice in data:
        ...
        total_score += (match_status_result_points[match_status] + choice_selection_points[player_choice])
...
def solution2(data):
    ...
    for opponent_choice, expected_result in data:
        ...
        total_score += choice_selection_points[player_choice] + match_status_result_points[opponent_choice+player_choice]
    print(f"Total: score {total_score}")
